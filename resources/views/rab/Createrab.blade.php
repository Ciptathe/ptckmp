...
<head>
  ...
  <title>Tambah Data Rab | PT CKMP</title>
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" enctype="multipart/form-data" action="{{ URL::to('simpandatarab')}}">
                {{-- diatas memanggil fungsi storerab pada rabcontroller dengan nama link simpandatarab --}}
            @csrf   
            <div class="card-body">
