...
<head>
  ...
  <title>Edit Data Rab | PT CKMP</title>
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" enctype="multipart/form-data" action="/updatedatarab/{{$var_rab->id}}">
                {{-- diatas memanggil fungsi storerab pada rabcontroller dengan nama link simpandatalampu --}}
            @csrf   
            <div class="card-body">
                <div class="form-group">
                    <label for="no">No *</label>
                    <input type="Text"  name="no" class="form-control" value="{{$var_rab->no}}">
                </div>
                <div class="form-group">
                    <label for="uraian_pekerjaan">Uraian Pekerjaan *</label>
                    <input type="Text" name="uraian_pekerjaan" class="form-control" value="{{$var_rab->uraian_pekerjaan}}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <select name="" class="form-control">   
                        <label >Kategori : Hanya Ls | Pkt | M3 | Kg | Bh</label>
                </div>
                <div class="form-group">
                    <label for="volume">Volume*</label>
                    <input type="Text" name="volume" class="form-control" value="{{$var_rab->volume}}">
                </div>
                <div class="form-group">
                    <label for="harga_satuan">Harga Satuan*</label>
                    <input type="Text" name="harga_satuan" class="form-control" value="{{$var_rab->harga_satuan}}">
                </div>
                
                <div class="form-group">
                    <label for="jumlah">Jumlah*</label>
                    <input type="Text" name="jumlah" class="form-control" value="{{$var_rab->jumlah}}">
                </div>
                <div class="form-group">
                    <label for="foto">Upload Foto*</label>
                    <input type="File" name="foto" class="form-control" value="{{$var_rab->foto}}" >
                    <img src="{{ asset('fotorab/'.$var_rab->foto) }}" width="70px" height="70px" >
                </div>
