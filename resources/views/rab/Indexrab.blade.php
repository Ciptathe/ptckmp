          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="col-auto">
                 <a href="{{url('/createrab')}}"  class="btn btn-light"> Input Rab</a> 
                  <a href="{{url('/linkcetakrabpdf')}}"  class="btn btn-info btn-md"> Download PDF</a> 
                  <a href="{{url('/linkcetakrabexcel')}}" class="btn btn-success"> Eksport Excel</a>
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$value->jumlah}}</td>
                            <td>
                              {{-- <img src="{{asset('fotorab/'.$value->foto) }}" style="width:60px;"> --}}
                               <img src="{{asset('fotorab/'.$value->foto) }}" style="width:100px; height:100px" >
                            </td>
                
                             
                        <td>
                        <a class="btn btn-primary" href="/editrab/{{ $value->id }}">Edit Data</a>
                        <a class="btn btn-danger" href="/delete/{{ $value->id }}">Hapus Data</a>
