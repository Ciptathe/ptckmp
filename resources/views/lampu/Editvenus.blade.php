...
<head>
  ...
  <title>Edit Data Lampu | PT CKMP</title>
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" enctype="multipart/form-data" action="/updatedata/{{$var_lampu->id}}">
                {{-- diatas memanggil fungsi storerab pada rabcontroller dengan nama link simpandatalampu --}}
            @csrf   
            <div class="card-body">
            <div class="form-group">
                <label for="Instansi">Instansi *</label>
                <input type="Text" name="instansi" class="form-control" value="{{$var_lampu->instansi}}">
            </div>
            <div class="form-group">
                <label for="Lokasi">Lokasi *</label>
                <input type="Text" name="lokasi" class="form-control" value="{{$var_lampu->lokasi}}" >
            </div>
            <div class="form-group">
                <label for="Jumlah">Jumlah *</label>
                <input type="Text" name="jumlah" class="form-control" value="{{$var_lampu->jumlah}}">
            </div>
            <div class="form-group">
                <label for="keterangan">Keterangan *</label>
                <select name="keterangan" class="form-control" value="{{$var_lampu->keterangan}}">
            ...
            <div class="form-group">
                ...
                <input type="Text" name="bayar" class="form-control" value="{{$var_lampu->bayar}}">
            </div>
            <div class="form-group">
                <label for="belumbayar">Belum Bayar*</label>
                <input type="Text" name="belumbayar" class="form-control" value="{{$var_lampu->belumbayar}}">
            </div>
            
            <div class="form-group">
              <div><img src="{{ asset('fotolampu/'.$var_lampu->foto) }}" width="70px" height="70px" ></div>
                <label for="exampleInputFile">Upload Foto</label>
                <div class="input-group">
                  <div class="custom-file">
                    <input type="file" name="foto" class="custom-file-input" value="{{$var_lampu->foto}}">
